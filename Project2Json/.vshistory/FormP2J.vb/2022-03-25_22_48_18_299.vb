...
Public Class FormP2J
    ...
    Private Sub Quit_Click(sender As Object, e As EventArgs) Handles Quit.Click
        ...
        Debug.Print(table.Rows(0).Item(3).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture))
        Debug.Print(table.Rows(1).Item(3).ToString("MM/dd/yyyy", CultureInfo.InvariantCulture))
        'Application.Exit()
    End Sub
